...
void* emscripten_GetProcAddress_full(const char *name_) {
  ...
  // main list
  else if (!strcmp(name, "glClearIndex")) return emscripten_glClearIndex;
  else if (!strcmp(name, "glClearColor")) return emscripten_glClearColor;
  else if (!strcmp(name, "glClear")) return emscripten_glClear;
  else if (!strcmp(name, "glIndexMask")) return emscripten_glIndexMask;
  else if (!strcmp(name, "glColorMask")) return emscripten_glColorMask;
  else if (!strcmp(name, "glAlphaFunc")) return emscripten_glAlphaFunc;
  else if (!strcmp(name, "glBlendFunc")) return emscripten_glBlendFunc;
  else if (!strcmp(name, "glLogicOp")) return emscripten_glLogicOp;
  else if (!strcmp(name, "glCullFace")) return emscripten_glCullFace;
  else if (!strcmp(name, "glFrontFace")) return emscripten_glFrontFace;
  else if (!strcmp(name, "glPointSize")) return emscripten_glPointSize;
  else if (!strcmp(name, "glLineWidth")) return emscripten_glLineWidth;
  else if (!strcmp(name, "glLineStipple")) return emscripten_glLineStipple;
  else if (!strcmp(name, "glPolygonMode")) return emscripten_glPolygonMode;
  else if (!strcmp(name, "glPolygonOffset")) return emscripten_glPolygonOffset;
  else if (!strcmp(name, "glPolygonStipple")) return emscripten_glPolygonStipple;
  else if (!strcmp(name, "glGetPolygonStipple")) return emscripten_glGetPolygonStipple;
  else if (!strcmp(name, "glEdgeFlag")) return emscripten_glEdgeFlag;
  else if (!strcmp(name, "glEdgeFlagv")) return emscripten_glEdgeFlagv;
  else if (!strcmp(name, "glScissor")) return emscripten_glScissor;
  else if (!strcmp(name, "glClipPlane")) return emscripten_glClipPlane;
  else if (!strcmp(name, "glGetClipPlane")) return emscripten_glGetClipPlane;
  else if (!strcmp(name, "glDrawBuffer")) return emscripten_glDrawBuffer;
  ...
  else if (!strcmp(name, "glDisableClientState")) return emscripten_glDisableClientState;
  else if (!strcmp(name, "glGetBooleanv")) return emscripten_glGetBooleanv;
  else if (!strcmp(name, "glGetDoublev")) return emscripten_glGetDoublev;
  ...
  else if (!strcmp(name, "glPushAttrib")) return emscripten_glPushAttrib;
  else if (!strcmp(name, "glPopAttrib")) return emscripten_glPopAttrib;
  else if (!strcmp(name, "glPushClientAttrib")) return emscripten_glPushClientAttrib;
  else if (!strcmp(name, "glPopClientAttrib")) return emscripten_glPopClientAttrib;
  else if (!strcmp(name, "glRenderMode")) return emscripten_glRenderMode;
  ...
  else if (!strcmp(name, "glClearAccum")) return emscripten_glClearAccum;
  else if (!strcmp(name, "glAccum")) return emscripten_glAccum;
  else if (!strcmp(name, "glMatrixMode")) return emscripten_glMatrixMode;
  else if (!strcmp(name, "glOrtho")) return emscripten_glOrtho;
  else if (!strcmp(name, "glFrustum")) return emscripten_glFrustum;
  else if (!strcmp(name, "glViewport")) return emscripten_glViewport;
  else if (!strcmp(name, "glPushMatrix")) return emscripten_glPushMatrix;
  else if (!strcmp(name, "glPopMatrix")) return emscripten_glPopMatrix;
  else if (!strcmp(name, "glLoadIdentity")) return emscripten_glLoadIdentity;
  else if (!strcmp(name, "glLoadMatrixd")) return emscripten_glLoadMatrixd;
  else if (!strcmp(name, "glLoadMatrixf")) return emscripten_glLoadMatrixf;
  else if (!strcmp(name, "glMultMatrixd")) return emscripten_glMultMatrixd;
  else if (!strcmp(name, "glMultMatrixf")) return emscripten_glMultMatrixf;
  else if (!strcmp(name, "glRotated")) return emscripten_glRotated;
  else if (!strcmp(name, "glRotatef")) return emscripten_glRotatef;
  else if (!strcmp(name, "glScaled")) return emscripten_glScaled;
  else if (!strcmp(name, "glScalef")) return emscripten_glScalef;
  else if (!strcmp(name, "glTranslated")) return emscripten_glTranslated;
  else if (!strcmp(name, "glTranslatef")) return emscripten_glTranslatef;
  else if (!strcmp(name, "glIsList")) return emscripten_glIsList;
  else if (!strcmp(name, "glDeleteLists")) return emscripten_glDeleteLists;
  else if (!strcmp(name, "glGenLists")) return emscripten_glGenLists;
  else if (!strcmp(name, "glNewList")) return emscripten_glNewList;
  else if (!strcmp(name, "glEndList")) return emscripten_glEndList;
  else if (!strcmp(name, "glCallList")) return emscripten_glCallList;
  else if (!strcmp(name, "glCallLists")) return emscripten_glCallLists;
  else if (!strcmp(name, "glListBase")) return emscripten_glListBase;
  else if (!strcmp(name, "glBegin")) return emscripten_glBegin;
  else if (!strcmp(name, "glEnd")) return emscripten_glEnd;
  else if (!strcmp(name, "glVertex2d")) return emscripten_glVertex2d;
  else if (!strcmp(name, "glVertex2f")) return emscripten_glVertex2f;
  else if (!strcmp(name, "glVertex2i")) return emscripten_glVertex2i;
  else if (!strcmp(name, "glVertex2s")) return emscripten_glVertex2s;
  else if (!strcmp(name, "glVertex3d")) return emscripten_glVertex3d;
  else if (!strcmp(name, "glVertex3f")) return emscripten_glVertex3f;
  else if (!strcmp(name, "glVertex3i")) return emscripten_glVertex3i;
  else if (!strcmp(name, "glVertex3s")) return emscripten_glVertex3s;
  else if (!strcmp(name, "glVertex4d")) return emscripten_glVertex4d;
  else if (!strcmp(name, "glVertex4f")) return emscripten_glVertex4f;
  else if (!strcmp(name, "glVertex4i")) return emscripten_glVertex4i;
  else if (!strcmp(name, "glVertex4s")) return emscripten_glVertex4s;
  else if (!strcmp(name, "glVertex2dv")) return emscripten_glVertex2dv;
  else if (!strcmp(name, "glVertex2fv")) return emscripten_glVertex2fv;
  else if (!strcmp(name, "glVertex2iv")) return emscripten_glVertex2iv;
  else if (!strcmp(name, "glVertex2sv")) return emscripten_glVertex2sv;
  else if (!strcmp(name, "glVertex3dv")) return emscripten_glVertex3dv;
  else if (!strcmp(name, "glVertex3fv")) return emscripten_glVertex3fv;
  else if (!strcmp(name, "glVertex3iv")) return emscripten_glVertex3iv;
  else if (!strcmp(name, "glVertex3sv")) return emscripten_glVertex3sv;
  else if (!strcmp(name, "glVertex4dv")) return emscripten_glVertex4dv;
  else if (!strcmp(name, "glVertex4fv")) return emscripten_glVertex4fv;
  else if (!strcmp(name, "glVertex4iv")) return emscripten_glVertex4iv;
  else if (!strcmp(name, "glVertex4sv")) return emscripten_glVertex4sv;
  else if (!strcmp(name, "glNormal3b")) return emscripten_glNormal3b;
  else if (!strcmp(name, "glNormal3d")) return emscripten_glNormal3d;
  else if (!strcmp(name, "glNormal3f")) return emscripten_glNormal3f;
  else if (!strcmp(name, "glNormal3i")) return emscripten_glNormal3i;
  else if (!strcmp(name, "glNormal3s")) return emscripten_glNormal3s;
  else if (!strcmp(name, "glNormal3bv")) return emscripten_glNormal3bv;
  else if (!strcmp(name, "glNormal3dv")) return emscripten_glNormal3dv;
  else if (!strcmp(name, "glNormal3fv")) return emscripten_glNormal3fv;
  else if (!strcmp(name, "glNormal3iv")) return emscripten_glNormal3iv;
  else if (!strcmp(name, "glNormal3sv")) return emscripten_glNormal3sv;
  else if (!strcmp(name, "glIndexd")) return emscripten_glIndexd;
  else if (!strcmp(name, "glIndexf")) return emscripten_glIndexf;
  else if (!strcmp(name, "glIndexi")) return emscripten_glIndexi;
  else if (!strcmp(name, "glIndexs")) return emscripten_glIndexs;
  else if (!strcmp(name, "glIndexub")) return emscripten_glIndexub;
  else if (!strcmp(name, "glIndexdv")) return emscripten_glIndexdv;
  else if (!strcmp(name, "glIndexfv")) return emscripten_glIndexfv;
  else if (!strcmp(name, "glIndexiv")) return emscripten_glIndexiv;
  else if (!strcmp(name, "glIndexsv")) return emscripten_glIndexsv;
  else if (!strcmp(name, "glIndexubv")) return emscripten_glIndexubv;
  else if (!strcmp(name, "glColor3b")) return emscripten_glColor3b;
  else if (!strcmp(name, "glColor3d")) return emscripten_glColor3d;
  else if (!strcmp(name, "glColor3f")) return emscripten_glColor3f;
  else if (!strcmp(name, "glColor3i")) return emscripten_glColor3i;
  else if (!strcmp(name, "glColor3s")) return emscripten_glColor3s;
  else if (!strcmp(name, "glColor3ub")) return emscripten_glColor3ub;
  else if (!strcmp(name, "glColor3ui")) return emscripten_glColor3ui;
  else if (!strcmp(name, "glColor3us")) return emscripten_glColor3us;
  else if (!strcmp(name, "glColor4b")) return emscripten_glColor4b;
  else if (!strcmp(name, "glColor4d")) return emscripten_glColor4d;
  else if (!strcmp(name, "glColor4f")) return emscripten_glColor4f;
  else if (!strcmp(name, "glColor4i")) return emscripten_glColor4i;
  else if (!strcmp(name, "glColor4s")) return emscripten_glColor4s;
  else if (!strcmp(name, "glColor4ub")) return emscripten_glColor4ub;
  else if (!strcmp(name, "glColor4ui")) return emscripten_glColor4ui;
  else if (!strcmp(name, "glColor4us")) return emscripten_glColor4us;
  else if (!strcmp(name, "glColor3bv")) return emscripten_glColor3bv;
  else if (!strcmp(name, "glColor3dv")) return emscripten_glColor3dv;
  else if (!strcmp(name, "glColor3fv")) return emscripten_glColor3fv;
  else if (!strcmp(name, "glColor3iv")) return emscripten_glColor3iv;
  else if (!strcmp(name, "glColor3sv")) return emscripten_glColor3sv;
  else if (!strcmp(name, "glColor3ubv")) return emscripten_glColor3ubv;
  else if (!strcmp(name, "glColor3uiv")) return emscripten_glColor3uiv;
  else if (!strcmp(name, "glColor3usv")) return emscripten_glColor3usv;
  else if (!strcmp(name, "glColor4bv")) return emscripten_glColor4bv;
  else if (!strcmp(name, "glColor4dv")) return emscripten_glColor4dv;
  else if (!strcmp(name, "glColor4fv")) return emscripten_glColor4fv;
  else if (!strcmp(name, "glColor4iv")) return emscripten_glColor4iv;
  else if (!strcmp(name, "glColor4sv")) return emscripten_glColor4sv;
  else if (!strcmp(name, "glColor4ubv")) return emscripten_glColor4ubv;
  else if (!strcmp(name, "glColor4uiv")) return emscripten_glColor4uiv;
  else if (!strcmp(name, "glColor4usv")) return emscripten_glColor4usv;
  else if (!strcmp(name, "glTexCoord1d")) return emscripten_glTexCoord1d;
  else if (!strcmp(name, "glTexCoord1f")) return emscripten_glTexCoord1f;
  else if (!strcmp(name, "glTexCoord1i")) return emscripten_glTexCoord1i;
  else if (!strcmp(name, "glTexCoord1s")) return emscripten_glTexCoord1s;
  else if (!strcmp(name, "glTexCoord2d")) return emscripten_glTexCoord2d;
  else if (!strcmp(name, "glTexCoord2f")) return emscripten_glTexCoord2f;
  else if (!strcmp(name, "glTexCoord2i")) return emscripten_glTexCoord2i;
  else if (!strcmp(name, "glTexCoord2s")) return emscripten_glTexCoord2s;
  else if (!strcmp(name, "glTexCoord3d")) return emscripten_glTexCoord3d;
  else if (!strcmp(name, "glTexCoord3f")) return emscripten_glTexCoord3f;
  else if (!strcmp(name, "glTexCoord3i")) return emscripten_glTexCoord3i;
  else if (!strcmp(name, "glTexCoord3s")) return emscripten_glTexCoord3s;
  else if (!strcmp(name, "glTexCoord4d")) return emscripten_glTexCoord4d;
  else if (!strcmp(name, "glTexCoord4f")) return emscripten_glTexCoord4f;
  else if (!strcmp(name, "glTexCoord4i")) return emscripten_glTexCoord4i;
  else if (!strcmp(name, "glTexCoord4s")) return emscripten_glTexCoord4s;
  else if (!strcmp(name, "glTexCoord1dv")) return emscripten_glTexCoord1dv;
  else if (!strcmp(name, "glTexCoord1fv")) return emscripten_glTexCoord1fv;
  else if (!strcmp(name, "glTexCoord1iv")) return emscripten_glTexCoord1iv;
  else if (!strcmp(name, "glTexCoord1sv")) return emscripten_glTexCoord1sv;
  else if (!strcmp(name, "glTexCoord2dv")) return emscripten_glTexCoord2dv;
  else if (!strcmp(name, "glTexCoord2fv")) return emscripten_glTexCoord2fv;
  else if (!strcmp(name, "glTexCoord2iv")) return emscripten_glTexCoord2iv;
  else if (!strcmp(name, "glTexCoord2sv")) return emscripten_glTexCoord2sv;
  else if (!strcmp(name, "glTexCoord3dv")) return emscripten_glTexCoord3dv;
  else if (!strcmp(name, "glTexCoord3fv")) return emscripten_glTexCoord3fv;
  else if (!strcmp(name, "glTexCoord3iv")) return emscripten_glTexCoord3iv;
  else if (!strcmp(name, "glTexCoord3sv")) return emscripten_glTexCoord3sv;
  else if (!strcmp(name, "glTexCoord4dv")) return emscripten_glTexCoord4dv;
  else if (!strcmp(name, "glTexCoord4fv")) return emscripten_glTexCoord4fv;
  else if (!strcmp(name, "glTexCoord4iv")) return emscripten_glTexCoord4iv;
  else if (!strcmp(name, "glTexCoord4sv")) return emscripten_glTexCoord4sv;
  else if (!strcmp(name, "glRasterPos2d")) return emscripten_glRasterPos2d;
  else if (!strcmp(name, "glRasterPos2f")) return emscripten_glRasterPos2f;
  else if (!strcmp(name, "glRasterPos2i")) return emscripten_glRasterPos2i;
  else if (!strcmp(name, "glRasterPos2s")) return emscripten_glRasterPos2s;
  else if (!strcmp(name, "glRasterPos3d")) return emscripten_glRasterPos3d;
  else if (!strcmp(name, "glRasterPos3f")) return emscripten_glRasterPos3f;
  else if (!strcmp(name, "glRasterPos3i")) return emscripten_glRasterPos3i;
  else if (!strcmp(name, "glRasterPos3s")) return emscripten_glRasterPos3s;
  else if (!strcmp(name, "glRasterPos4d")) return emscripten_glRasterPos4d;
  else if (!strcmp(name, "glRasterPos4f")) return emscripten_glRasterPos4f;
  else if (!strcmp(name, "glRasterPos4i")) return emscripten_glRasterPos4i;
  else if (!strcmp(name, "glRasterPos4s")) return emscripten_glRasterPos4s;
  else if (!strcmp(name, "glRasterPos2dv")) return emscripten_glRasterPos2dv;
  else if (!strcmp(name, "glRasterPos2fv")) return emscripten_glRasterPos2fv;
  else if (!strcmp(name, "glRasterPos2iv")) return emscripten_glRasterPos2iv;
  else if (!strcmp(name, "glRasterPos2sv")) return emscripten_glRasterPos2sv;
  else if (!strcmp(name, "glRasterPos3dv")) return emscripten_glRasterPos3dv;
  else if (!strcmp(name, "glRasterPos3fv")) return emscripten_glRasterPos3fv;
  else if (!strcmp(name, "glRasterPos3iv")) return emscripten_glRasterPos3iv;
  else if (!strcmp(name, "glRasterPos3sv")) return emscripten_glRasterPos3sv;
  else if (!strcmp(name, "glRasterPos4dv")) return emscripten_glRasterPos4dv;
  else if (!strcmp(name, "glRasterPos4fv")) return emscripten_glRasterPos4fv;
  else if (!strcmp(name, "glRasterPos4iv")) return emscripten_glRasterPos4iv;
  else if (!strcmp(name, "glRasterPos4sv")) return emscripten_glRasterPos4sv;
  else if (!strcmp(name, "glRectd")) return emscripten_glRectd;
  else if (!strcmp(name, "glRectf")) return emscripten_glRectf;
  else if (!strcmp(name, "glRecti")) return emscripten_glRecti;
  else if (!strcmp(name, "glRects")) return emscripten_glRects;
  else if (!strcmp(name, "glRectdv")) return emscripten_glRectdv;
  else if (!strcmp(name, "glRectfv")) return emscripten_glRectfv;
  else if (!strcmp(name, "glRectiv")) return emscripten_glRectiv;
  else if (!strcmp(name, "glRectsv")) return emscripten_glRectsv;
  ...
  else if (!strcmp(name, "glIndexPointer")) return emscripten_glIndexPointer;
  else if (!strcmp(name, "glTexCoordPointer")) return emscripten_glTexCoordPointer;
  else if (!strcmp(name, "glEdgeFlagPointer")) return emscripten_glEdgeFlagPointer;
  else if (!strcmp(name, "glGetPointerv")) return emscripten_glGetPointerv;
  else if (!strcmp(name, "glArrayElement")) return emscripten_glArrayElement;
  ...
  else if (!strcmp(name, "glInterleavedArrays")) return emscripten_glInterleavedArrays;
  else if (!strcmp(name, "glShadeModel")) return emscripten_glShadeModel;
  else if (!strcmp(name, "glLightf")) return emscripten_glLightf;
  else if (!strcmp(name, "glLighti")) return emscripten_glLighti;
  else if (!strcmp(name, "glLightfv")) return emscripten_glLightfv;
  else if (!strcmp(name, "glLightiv")) return emscripten_glLightiv;
  else if (!strcmp(name, "glGetLightfv")) return emscripten_glGetLightfv;
  else if (!strcmp(name, "glGetLightiv")) return emscripten_glGetLightiv;
  else if (!strcmp(name, "glLightModelf")) return emscripten_glLightModelf;
  else if (!strcmp(name, "glLightModeli")) return emscripten_glLightModeli;
  else if (!strcmp(name, "glLightModelfv")) return emscripten_glLightModelfv;
  else if (!strcmp(name, "glLightModeliv")) return emscripten_glLightModeliv;
  else if (!strcmp(name, "glMaterialf")) return emscripten_glMaterialf;
  else if (!strcmp(name, "glMateriali")) return emscripten_glMateriali;
  else if (!strcmp(name, "glMaterialfv")) return emscripten_glMaterialfv;
  else if (!strcmp(name, "glMaterialiv")) return emscripten_glMaterialiv;
  else if (!strcmp(name, "glGetMaterialfv")) return emscripten_glGetMaterialfv;
  else if (!strcmp(name, "glGetMaterialiv")) return emscripten_glGetMaterialiv;
  else if (!strcmp(name, "glColorMaterial")) return emscripten_glColorMaterial;
  else if (!strcmp(name, "glPixelZoom")) return emscripten_glPixelZoom;
  else if (!strcmp(name, "glPixelStoref")) return emscripten_glPixelStoref;
  else if (!strcmp(name, "glPixelStorei")) return emscripten_glPixelStorei;
  else if (!strcmp(name, "glPixelTransferf")) return emscripten_glPixelTransferf;
  else if (!strcmp(name, "glPixelTransferi")) return emscripten_glPixelTransferi;
  else if (!strcmp(name, "glPixelMapfv")) return emscripten_glPixelMapfv;
  else if (!strcmp(name, "glPixelMapuiv")) return emscripten_glPixelMapuiv;
  else if (!strcmp(name, "glPixelMapusv")) return emscripten_glPixelMapusv;
  else if (!strcmp(name, "glGetPixelMapfv")) return emscripten_glGetPixelMapfv;
  else if (!strcmp(name, "glGetPixelMapuiv")) return emscripten_glGetPixelMapuiv;
  else if (!strcmp(name, "glGetPixelMapusv")) return emscripten_glGetPixelMapusv;
  else if (!strcmp(name, "glBitmap")) return emscripten_glBitmap;
  else if (!strcmp(name, "glReadPixels")) return emscripten_glReadPixels;
  else if (!strcmp(name, "glDrawPixels")) return emscripten_glDrawPixels;
  else if (!strcmp(name, "glCopyPixels")) return emscripten_glCopyPixels;
  ...
  else if (!strcmp(name, "glTexGend")) return emscripten_glTexGend;
  else if (!strcmp(name, "glTexGenf")) return emscripten_glTexGenf;
  else if (!strcmp(name, "glTexGeni")) return emscripten_glTexGeni;
  else if (!strcmp(name, "glTexGendv")) return emscripten_glTexGendv;
  else if (!strcmp(name, "glTexGenfv")) return emscripten_glTexGenfv;
  else if (!strcmp(name, "glTexGeniv")) return emscripten_glTexGeniv;
  else if (!strcmp(name, "glGetTexGendv")) return emscripten_glGetTexGendv;
  else if (!strcmp(name, "glGetTexGenfv")) return emscripten_glGetTexGenfv;
  else if (!strcmp(name, "glGetTexGeniv")) return emscripten_glGetTexGeniv;
  else if (!strcmp(name, "glTexEnvf")) return emscripten_glTexEnvf;
  else if (!strcmp(name, "glTexEnvi")) return emscripten_glTexEnvi;
  else if (!strcmp(name, "glTexEnvfv")) return emscripten_glTexEnvfv;
  else if (!strcmp(name, "glTexEnviv")) return emscripten_glTexEnviv;
  else if (!strcmp(name, "glGetTexEnvfv")) return emscripten_glGetTexEnvfv;
  else if (!strcmp(name, "glGetTexEnviv")) return emscripten_glGetTexEnviv;
  ...
  else if (!strcmp(name, "glGetTexLevelParameterfv")) return emscripten_glGetTexLevelParameterfv;
  else if (!strcmp(name, "glGetTexLevelParameteriv")) return emscripten_glGetTexLevelParameteriv;
  else if (!strcmp(name, "glTexImage1D")) return emscripten_glTexImage1D;
  else if (!strcmp(name, "glTexImage2D")) return emscripten_glTexImage2D;
  else if (!strcmp(name, "glGetTexImage")) return emscripten_glGetTexImage;
  ...
  else if (!strcmp(name, "glPrioritizeTextures")) return emscripten_glPrioritizeTextures;
  else if (!strcmp(name, "glAreTexturesResident")) return emscripten_glAreTexturesResident;
  else if (!strcmp(name, "glIsTexture")) return emscripten_glIsTexture;
  else if (!strcmp(name, "glTexSubImage1D")) return emscripten_glTexSubImage1D;
  else if (!strcmp(name, "glTexSubImage2D")) return emscripten_glTexSubImage2D;
  else if (!strcmp(name, "glCopyTexImage1D")) return emscripten_glCopyTexImage1D;
  else if (!strcmp(name, "glCopyTexImage2D")) return emscripten_glCopyTexImage2D;
  else if (!strcmp(name, "glCopyTexSubImage1D")) return emscripten_glCopyTexSubImage1D;
  else if (!strcmp(name, "glCopyTexSubImage2D")) return emscripten_glCopyTexSubImage2D;
  else if (!strcmp(name, "glMap1d")) return emscripten_glMap1d;
  else if (!strcmp(name, "glMap1f")) return emscripten_glMap1f;
  else if (!strcmp(name, "glMap2d")) return emscripten_glMap2d;
  else if (!strcmp(name, "glMap2f")) return emscripten_glMap2f;
  else if (!strcmp(name, "glGetMapdv")) return emscripten_glGetMapdv;
  else if (!strcmp(name, "glGetMapfv")) return emscripten_glGetMapfv;
  else if (!strcmp(name, "glGetMapiv")) return emscripten_glGetMapiv;
  else if (!strcmp(name, "glEvalCoord1d")) return emscripten_glEvalCoord1d;
  else if (!strcmp(name, "glEvalCoord1f")) return emscripten_glEvalCoord1f;
  else if (!strcmp(name, "glEvalCoord1dv")) return emscripten_glEvalCoord1dv;
  else if (!strcmp(name, "glEvalCoord1fv")) return emscripten_glEvalCoord1fv;
  else if (!strcmp(name, "glEvalCoord2d")) return emscripten_glEvalCoord2d;
  else if (!strcmp(name, "glEvalCoord2f")) return emscripten_glEvalCoord2f;
  else if (!strcmp(name, "glEvalCoord2dv")) return emscripten_glEvalCoord2dv;
  else if (!strcmp(name, "glEvalCoord2fv")) return emscripten_glEvalCoord2fv;
  else if (!strcmp(name, "glMapGrid1d")) return emscripten_glMapGrid1d;
  else if (!strcmp(name, "glMapGrid1f")) return emscripten_glMapGrid1f;
  else if (!strcmp(name, "glMapGrid2d")) return emscripten_glMapGrid2d;
  else if (!strcmp(name, "glMapGrid2f")) return emscripten_glMapGrid2f;
  else if (!strcmp(name, "glEvalPoint1")) return emscripten_glEvalPoint1;
  else if (!strcmp(name, "glEvalPoint2")) return emscripten_glEvalPoint2;
  else if (!strcmp(name, "glEvalMesh1")) return emscripten_glEvalMesh1;
  else if (!strcmp(name, "glEvalMesh2")) return emscripten_glEvalMesh2;
  else if (!strcmp(name, "glFogf")) return emscripten_glFogf;
  else if (!strcmp(name, "glFogi")) return emscripten_glFogi;
  else if (!strcmp(name, "glFogfv")) return emscripten_glFogfv;
  else if (!strcmp(name, "glFogiv")) return emscripten_glFogiv;
  else if (!strcmp(name, "glFeedbackBuffer")) return emscripten_glFeedbackBuffer;
  else if (!strcmp(name, "glPassThrough")) return emscripten_glPassThrough;
  else if (!strcmp(name, "glSelectBuffer")) return emscripten_glSelectBuffer;
  else if (!strcmp(name, "glInitNames")) return emscripten_glInitNames;
  else if (!strcmp(name, "glLoadName")) return emscripten_glLoadName;
  else if (!strcmp(name, "glPushName")) return emscripten_glPushName;
  else if (!strcmp(name, "glPopName")) return emscripten_glPopName;
  ...
  else if (!strcmp(name, "glColorTable")) return emscripten_glColorTable;
  else if (!strcmp(name, "glColorSubTable")) return emscripten_glColorSubTable;
  else if (!strcmp(name, "glColorTableParameteriv")) return emscripten_glColorTableParameteriv;
  else if (!strcmp(name, "glColorTableParameterfv")) return emscripten_glColorTableParameterfv;
  else if (!strcmp(name, "glCopyColorSubTable")) return emscripten_glCopyColorSubTable;
  else if (!strcmp(name, "glCopyColorTable")) return emscripten_glCopyColorTable;
  else if (!strcmp(name, "glGetColorTable")) return emscripten_glGetColorTable;
  else if (!strcmp(name, "glGetColorTableParameterfv")) return emscripten_glGetColorTableParameterfv;
  else if (!strcmp(name, "glGetColorTableParameteriv")) return emscripten_glGetColorTableParameteriv;
  ...
  else if (!strcmp(name, "glHistogram")) return emscripten_glHistogram;
  else if (!strcmp(name, "glResetHistogram")) return emscripten_glResetHistogram;
  else if (!strcmp(name, "glGetHistogram")) return emscripten_glGetHistogram;
  else if (!strcmp(name, "glGetHistogramParameterfv")) return emscripten_glGetHistogramParameterfv;
  else if (!strcmp(name, "glGetHistogramParameteriv")) return emscripten_glGetHistogramParameteriv;
  else if (!strcmp(name, "glMinmax")) return emscripten_glMinmax;
  else if (!strcmp(name, "glResetMinmax")) return emscripten_glResetMinmax;
  else if (!strcmp(name, "glGetMinmax")) return emscripten_glGetMinmax;
  else if (!strcmp(name, "glGetMinmaxParameterfv")) return emscripten_glGetMinmaxParameterfv;
  else if (!strcmp(name, "glGetMinmaxParameteriv")) return emscripten_glGetMinmaxParameteriv;
  else if (!strcmp(name, "glConvolutionFilter1D")) return emscripten_glConvolutionFilter1D;
  else if (!strcmp(name, "glConvolutionFilter2D")) return emscripten_glConvolutionFilter2D;
  else if (!strcmp(name, "glConvolutionParameterf")) return emscripten_glConvolutionParameterf;
  else if (!strcmp(name, "glConvolutionParameterfv")) return emscripten_glConvolutionParameterfv;
  else if (!strcmp(name, "glConvolutionParameteri")) return emscripten_glConvolutionParameteri;
  else if (!strcmp(name, "glConvolutionParameteriv")) return emscripten_glConvolutionParameteriv;
  else if (!strcmp(name, "glCopyConvolutionFilter1D")) return emscripten_glCopyConvolutionFilter1D;
  else if (!strcmp(name, "glCopyConvolutionFilter2D")) return emscripten_glCopyConvolutionFilter2D;
  else if (!strcmp(name, "glGetConvolutionFilter")) return emscripten_glGetConvolutionFilter;
  else if (!strcmp(name, "glGetConvolutionParameterfv")) return emscripten_glGetConvolutionParameterfv;
  else if (!strcmp(name, "glGetConvolutionParameteriv")) return emscripten_glGetConvolutionParameteriv;
  else if (!strcmp(name, "glSeparableFilter2D")) return emscripten_glSeparableFilter2D;
  else if (!strcmp(name, "glGetSeparableFilter")) return emscripten_glGetSeparableFilter;
  ...
  else if (!strcmp(name, "glCompressedTexImage1D")) return emscripten_glCompressedTexImage1D;
  ...
  else if (!strcmp(name, "glCompressedTexSubImage1D")) return emscripten_glCompressedTexSubImage1D;
  ...
  else if (!strcmp(name, "glGetCompressedTexImage")) return emscripten_glGetCompressedTexImage;
  else if (!strcmp(name, "glMultiTexCoord1d")) return emscripten_glMultiTexCoord1d;
  else if (!strcmp(name, "glMultiTexCoord1dv")) return emscripten_glMultiTexCoord1dv;
  else if (!strcmp(name, "glMultiTexCoord1f")) return emscripten_glMultiTexCoord1f;
  else if (!strcmp(name, "glMultiTexCoord1fv")) return emscripten_glMultiTexCoord1fv;
  else if (!strcmp(name, "glMultiTexCoord1i")) return emscripten_glMultiTexCoord1i;
  else if (!strcmp(name, "glMultiTexCoord1iv")) return emscripten_glMultiTexCoord1iv;
  else if (!strcmp(name, "glMultiTexCoord1s")) return emscripten_glMultiTexCoord1s;
  else if (!strcmp(name, "glMultiTexCoord1sv")) return emscripten_glMultiTexCoord1sv;
  else if (!strcmp(name, "glMultiTexCoord2d")) return emscripten_glMultiTexCoord2d;
  else if (!strcmp(name, "glMultiTexCoord2dv")) return emscripten_glMultiTexCoord2dv;
  else if (!strcmp(name, "glMultiTexCoord2f")) return emscripten_glMultiTexCoord2f;
  else if (!strcmp(name, "glMultiTexCoord2fv")) return emscripten_glMultiTexCoord2fv;
  else if (!strcmp(name, "glMultiTexCoord2i")) return emscripten_glMultiTexCoord2i;
  else if (!strcmp(name, "glMultiTexCoord2iv")) return emscripten_glMultiTexCoord2iv;
  else if (!strcmp(name, "glMultiTexCoord2s")) return emscripten_glMultiTexCoord2s;
  else if (!strcmp(name, "glMultiTexCoord2sv")) return emscripten_glMultiTexCoord2sv;
  else if (!strcmp(name, "glMultiTexCoord3d")) return emscripten_glMultiTexCoord3d;
  else if (!strcmp(name, "glMultiTexCoord3dv")) return emscripten_glMultiTexCoord3dv;
  else if (!strcmp(name, "glMultiTexCoord3f")) return emscripten_glMultiTexCoord3f;
  else if (!strcmp(name, "glMultiTexCoord3fv")) return emscripten_glMultiTexCoord3fv;
  else if (!strcmp(name, "glMultiTexCoord3i")) return emscripten_glMultiTexCoord3i;
  else if (!strcmp(name, "glMultiTexCoord3iv")) return emscripten_glMultiTexCoord3iv;
  else if (!strcmp(name, "glMultiTexCoord3s")) return emscripten_glMultiTexCoord3s;
  else if (!strcmp(name, "glMultiTexCoord3sv")) return emscripten_glMultiTexCoord3sv;
  else if (!strcmp(name, "glMultiTexCoord4d")) return emscripten_glMultiTexCoord4d;
  else if (!strcmp(name, "glMultiTexCoord4dv")) return emscripten_glMultiTexCoord4dv;
  else if (!strcmp(name, "glMultiTexCoord4f")) return emscripten_glMultiTexCoord4f;
  else if (!strcmp(name, "glMultiTexCoord4fv")) return emscripten_glMultiTexCoord4fv;
  else if (!strcmp(name, "glMultiTexCoord4i")) return emscripten_glMultiTexCoord4i;
  else if (!strcmp(name, "glMultiTexCoord4iv")) return emscripten_glMultiTexCoord4iv;
  else if (!strcmp(name, "glMultiTexCoord4s")) return emscripten_glMultiTexCoord4s;
  else if (!strcmp(name, "glMultiTexCoord4sv")) return emscripten_glMultiTexCoord4sv;
  else if (!strcmp(name, "glLoadTransposeMatrixd")) return emscripten_glLoadTransposeMatrixd;
  else if (!strcmp(name, "glLoadTransposeMatrixf")) return emscripten_glLoadTransposeMatrixf;
  else if (!strcmp(name, "glMultTransposeMatrixd")) return emscripten_glMultTransposeMatrixd;
  else if (!strcmp(name, "glMultTransposeMatrixf")) return emscripten_glMultTransposeMatrixf;
  else if (!strcmp(name, "glSampleCoverage")) return emscripten_glSampleCoverage;
  else if (!strcmp(name, "glActiveTextureARB")) return emscripten_glActiveTextureARB;
  else if (!strcmp(name, "glClientActiveTextureARB")) return emscripten_glClientActiveTextureARB;
  else if (!strcmp(name, "glMultiTexCoord1dARB")) return emscripten_glMultiTexCoord1dARB;
  else if (!strcmp(name, "glMultiTexCoord1dvARB")) return emscripten_glMultiTexCoord1dvARB;
  else if (!strcmp(name, "glMultiTexCoord1fARB")) return emscripten_glMultiTexCoord1fARB;
  else if (!strcmp(name, "glMultiTexCoord1fvARB")) return emscripten_glMultiTexCoord1fvARB;
  else if (!strcmp(name, "glMultiTexCoord1iARB")) return emscripten_glMultiTexCoord1iARB;
  else if (!strcmp(name, "glMultiTexCoord1ivARB")) return emscripten_glMultiTexCoord1ivARB;
  else if (!strcmp(name, "glMultiTexCoord1sARB")) return emscripten_glMultiTexCoord1sARB;
  else if (!strcmp(name, "glMultiTexCoord1svARB")) return emscripten_glMultiTexCoord1svARB;
  else if (!strcmp(name, "glMultiTexCoord2dARB")) return emscripten_glMultiTexCoord2dARB;
  else if (!strcmp(name, "glMultiTexCoord2dvARB")) return emscripten_glMultiTexCoord2dvARB;
  else if (!strcmp(name, "glMultiTexCoord2fARB")) return emscripten_glMultiTexCoord2fARB;
  else if (!strcmp(name, "glMultiTexCoord2fvARB")) return emscripten_glMultiTexCoord2fvARB;
  else if (!strcmp(name, "glMultiTexCoord2iARB")) return emscripten_glMultiTexCoord2iARB;
  else if (!strcmp(name, "glMultiTexCoord2ivARB")) return emscripten_glMultiTexCoord2ivARB;
  else if (!strcmp(name, "glMultiTexCoord2sARB")) return emscripten_glMultiTexCoord2sARB;
  else if (!strcmp(name, "glMultiTexCoord2svARB")) return emscripten_glMultiTexCoord2svARB;
  else if (!strcmp(name, "glMultiTexCoord3dARB")) return emscripten_glMultiTexCoord3dARB;
  else if (!strcmp(name, "glMultiTexCoord3dvARB")) return emscripten_glMultiTexCoord3dvARB;
  else if (!strcmp(name, "glMultiTexCoord3fARB")) return emscripten_glMultiTexCoord3fARB;
  else if (!strcmp(name, "glMultiTexCoord3fvARB")) return emscripten_glMultiTexCoord3fvARB;
  else if (!strcmp(name, "glMultiTexCoord3iARB")) return emscripten_glMultiTexCoord3iARB;
  else if (!strcmp(name, "glMultiTexCoord3ivARB")) return emscripten_glMultiTexCoord3ivARB;
  else if (!strcmp(name, "glMultiTexCoord3sARB")) return emscripten_glMultiTexCoord3sARB;
  else if (!strcmp(name, "glMultiTexCoord3svARB")) return emscripten_glMultiTexCoord3svARB;
  else if (!strcmp(name, "glMultiTexCoord4dARB")) return emscripten_glMultiTexCoord4dARB;
  else if (!strcmp(name, "glMultiTexCoord4dvARB")) return emscripten_glMultiTexCoord4dvARB;
  else if (!strcmp(name, "glMultiTexCoord4fARB")) return emscripten_glMultiTexCoord4fARB;
  else if (!strcmp(name, "glMultiTexCoord4fvARB")) return emscripten_glMultiTexCoord4fvARB;
  else if (!strcmp(name, "glMultiTexCoord4iARB")) return emscripten_glMultiTexCoord4iARB;
  else if (!strcmp(name, "glMultiTexCoord4ivARB")) return emscripten_glMultiTexCoord4ivARB;
  else if (!strcmp(name, "glMultiTexCoord4sARB")) return emscripten_glMultiTexCoord4sARB;
  else if (!strcmp(name, "glMultiTexCoord4svARB")) return emscripten_glMultiTexCoord4svARB;
  else if (!strcmp(name, "glBlendColor")) return emscripten_glBlendColor;
  else if (!strcmp(name, "glBlendEquation")) return emscripten_glBlendEquation;
  else if (!strcmp(name, "glDrawRangeElements")) return emscripten_glDrawRangeElements;
  else if (!strcmp(name, "glTexImage3D")) return emscripten_glTexImage3D;
  ...
  else if (!strcmp(name, "glMultiDrawArrays")) return emscripten_glMultiDrawArrays;
  else if (!strcmp(name, "glMultiDrawElements")) return emscripten_glMultiDrawElements;
  else if (!strcmp(name, "glPointParameterf")) return emscripten_glPointParameterf;
  else if (!strcmp(name, "glPointParameterfv")) return emscripten_glPointParameterfv;
  else if (!strcmp(name, "glPointParameteri")) return emscripten_glPointParameteri;
  else if (!strcmp(name, "glPointParameteriv")) return emscripten_glPointParameteriv;
  else if (!strcmp(name, "glFogCoordf")) return emscripten_glFogCoordf;
  else if (!strcmp(name, "glFogCoordfv")) return emscripten_glFogCoordfv;
  else if (!strcmp(name, "glFogCoordd")) return emscripten_glFogCoordd;
  else if (!strcmp(name, "glFogCoorddv")) return emscripten_glFogCoorddv;
  else if (!strcmp(name, "glFogCoordPointer")) return emscripten_glFogCoordPointer;
  else if (!strcmp(name, "glSecondaryColor3b")) return emscripten_glSecondaryColor3b;
  else if (!strcmp(name, "glSecondaryColor3bv")) return emscripten_glSecondaryColor3bv;
  else if (!strcmp(name, "glSecondaryColor3d")) return emscripten_glSecondaryColor3d;
  else if (!strcmp(name, "glSecondaryColor3dv")) return emscripten_glSecondaryColor3dv;
  else if (!strcmp(name, "glSecondaryColor3f")) return emscripten_glSecondaryColor3f;
  else if (!strcmp(name, "glSecondaryColor3fv")) return emscripten_glSecondaryColor3fv;
  else if (!strcmp(name, "glSecondaryColor3i")) return emscripten_glSecondaryColor3i;
  else if (!strcmp(name, "glSecondaryColor3iv")) return emscripten_glSecondaryColor3iv;
  else if (!strcmp(name, "glSecondaryColor3s")) return emscripten_glSecondaryColor3s;
  else if (!strcmp(name, "glSecondaryColor3sv")) return emscripten_glSecondaryColor3sv;
  else if (!strcmp(name, "glSecondaryColor3ub")) return emscripten_glSecondaryColor3ub;
  else if (!strcmp(name, "glSecondaryColor3ubv")) return emscripten_glSecondaryColor3ubv;
  else if (!strcmp(name, "glSecondaryColor3ui")) return emscripten_glSecondaryColor3ui;
  else if (!strcmp(name, "glSecondaryColor3uiv")) return emscripten_glSecondaryColor3uiv;
  else if (!strcmp(name, "glSecondaryColor3us")) return emscripten_glSecondaryColor3us;
  else if (!strcmp(name, "glSecondaryColor3usv")) return emscripten_glSecondaryColor3usv;
  else if (!strcmp(name, "glSecondaryColorPointer")) return emscripten_glSecondaryColorPointer;
  else if (!strcmp(name, "glWindowPos2d")) return emscripten_glWindowPos2d;
  else if (!strcmp(name, "glWindowPos2dv")) return emscripten_glWindowPos2dv;
  else if (!strcmp(name, "glWindowPos2f")) return emscripten_glWindowPos2f;
  else if (!strcmp(name, "glWindowPos2fv")) return emscripten_glWindowPos2fv;
  else if (!strcmp(name, "glWindowPos2i")) return emscripten_glWindowPos2i;
  else if (!strcmp(name, "glWindowPos2iv")) return emscripten_glWindowPos2iv;
  else if (!strcmp(name, "glWindowPos2s")) return emscripten_glWindowPos2s;
  else if (!strcmp(name, "glWindowPos2sv")) return emscripten_glWindowPos2sv;
  else if (!strcmp(name, "glWindowPos3d")) return emscripten_glWindowPos3d;
  else if (!strcmp(name, "glWindowPos3dv")) return emscripten_glWindowPos3dv;
  else if (!strcmp(name, "glWindowPos3f")) return emscripten_glWindowPos3f;
  else if (!strcmp(name, "glWindowPos3fv")) return emscripten_glWindowPos3fv;
  else if (!strcmp(name, "glWindowPos3i")) return emscripten_glWindowPos3i;
  else if (!strcmp(name, "glWindowPos3iv")) return emscripten_glWindowPos3iv;
  else if (!strcmp(name, "glWindowPos3s")) return emscripten_glWindowPos3s;
  else if (!strcmp(name, "glWindowPos3sv")) return emscripten_glWindowPos3sv;
  ...
  else if (!strcmp(name, "glGetQueryObjectiv")) return emscripten_glGetQueryObjectiv;
  ...
  else if (!strcmp(name, "glGetBufferSubData")) return emscripten_glGetBufferSubData;
  else if (!strcmp(name, "glMapBuffer")) return emscripten_glMapBuffer;
  ...
  else if (!strcmp(name, "glGetVertexAttribdv")) return emscripten_glGetVertexAttribdv;
  ...
  else if (!strcmp(name, "glVertexAttrib1d")) return emscripten_glVertexAttrib1d;
  else if (!strcmp(name, "glVertexAttrib1dv")) return emscripten_glVertexAttrib1dv;
  ...
  else if (!strcmp(name, "glVertexAttrib1s")) return emscripten_glVertexAttrib1s;
  else if (!strcmp(name, "glVertexAttrib1sv")) return emscripten_glVertexAttrib1sv;
  else if (!strcmp(name, "glVertexAttrib2d")) return emscripten_glVertexAttrib2d;
  else if (!strcmp(name, "glVertexAttrib2dv")) return emscripten_glVertexAttrib2dv;
  ...
  else if (!strcmp(name, "glVertexAttrib2s")) return emscripten_glVertexAttrib2s;
  else if (!strcmp(name, "glVertexAttrib2sv")) return emscripten_glVertexAttrib2sv;
  else if (!strcmp(name, "glVertexAttrib3d")) return emscripten_glVertexAttrib3d;
  else if (!strcmp(name, "glVertexAttrib3dv")) return emscripten_glVertexAttrib3dv;
  ...
  else if (!strcmp(name, "glVertexAttrib3s")) return emscripten_glVertexAttrib3s;
  else if (!strcmp(name, "glVertexAttrib3sv")) return emscripten_glVertexAttrib3sv;
  else if (!strcmp(name, "glVertexAttrib4Nbv")) return emscripten_glVertexAttrib4Nbv;
  else if (!strcmp(name, "glVertexAttrib4Niv")) return emscripten_glVertexAttrib4Niv;
  else if (!strcmp(name, "glVertexAttrib4Nsv")) return emscripten_glVertexAttrib4Nsv;
  else if (!strcmp(name, "glVertexAttrib4Nub")) return emscripten_glVertexAttrib4Nub;
  else if (!strcmp(name, "glVertexAttrib4Nubv")) return emscripten_glVertexAttrib4Nubv;
  else if (!strcmp(name, "glVertexAttrib4Nuiv")) return emscripten_glVertexAttrib4Nuiv;
  else if (!strcmp(name, "glVertexAttrib4Nusv")) return emscripten_glVertexAttrib4Nusv;
  else if (!strcmp(name, "glVertexAttrib4bv")) return emscripten_glVertexAttrib4bv;
  else if (!strcmp(name, "glVertexAttrib4d")) return emscripten_glVertexAttrib4d;
  else if (!strcmp(name, "glVertexAttrib4dv")) return emscripten_glVertexAttrib4dv;
  ...
  else if (!strcmp(name, "glVertexAttrib4iv")) return emscripten_glVertexAttrib4iv;
  else if (!strcmp(name, "glVertexAttrib4s")) return emscripten_glVertexAttrib4s;
  else if (!strcmp(name, "glVertexAttrib4sv")) return emscripten_glVertexAttrib4sv;
  else if (!strcmp(name, "glVertexAttrib4ubv")) return emscripten_glVertexAttrib4ubv;
  else if (!strcmp(name, "glVertexAttrib4uiv")) return emscripten_glVertexAttrib4uiv;
  else if (!strcmp(name, "glVertexAttrib4usv")) return emscripten_glVertexAttrib4usv;
  ...
  else if (!strcmp(name, "glColorMaski")) return emscripten_glColorMaski;
  else if (!strcmp(name, "glGetBooleani_v")) return emscripten_glGetBooleani_v;
  else if (!strcmp(name, "glGetIntegeri_v")) return emscripten_glGetIntegeri_v;
  else if (!strcmp(name, "glEnablei")) return emscripten_glEnablei;
  else if (!strcmp(name, "glDisablei")) return emscripten_glDisablei;
  else if (!strcmp(name, "glIsEnabledi")) return emscripten_glIsEnabledi;
  ...
  else if (!strcmp(name, "glClampColor")) return emscripten_glClampColor;
  else if (!strcmp(name, "glBeginConditionalRender")) return emscripten_glBeginConditionalRender;
  else if (!strcmp(name, "glEndConditionalRender")) return emscripten_glEndConditionalRender;
  ...
  else if (!strcmp(name, "glVertexAttribI1i")) return emscripten_glVertexAttribI1i;
  else if (!strcmp(name, "glVertexAttribI2i")) return emscripten_glVertexAttribI2i;
  else if (!strcmp(name, "glVertexAttribI3i")) return emscripten_glVertexAttribI3i;
  else if (!strcmp(name, "glVertexAttribI4i")) return emscripten_glVertexAttribI4i;
  else if (!strcmp(name, "glVertexAttribI1ui")) return emscripten_glVertexAttribI1ui;
  else if (!strcmp(name, "glVertexAttribI2ui")) return emscripten_glVertexAttribI2ui;
  else if (!strcmp(name, "glVertexAttribI3ui")) return emscripten_glVertexAttribI3ui;
  else if (!strcmp(name, "glVertexAttribI4ui")) return emscripten_glVertexAttribI4ui;
  else if (!strcmp(name, "glVertexAttribI1iv")) return emscripten_glVertexAttribI1iv;
  else if (!strcmp(name, "glVertexAttribI2iv")) return emscripten_glVertexAttribI2iv;
  else if (!strcmp(name, "glVertexAttribI3iv")) return emscripten_glVertexAttribI3iv;
  else if (!strcmp(name, "glVertexAttribI4iv")) return emscripten_glVertexAttribI4iv;
  else if (!strcmp(name, "glVertexAttribI1uiv")) return emscripten_glVertexAttribI1uiv;
  else if (!strcmp(name, "glVertexAttribI2uiv")) return emscripten_glVertexAttribI2uiv;
  else if (!strcmp(name, "glVertexAttribI3uiv")) return emscripten_glVertexAttribI3uiv;
  else if (!strcmp(name, "glVertexAttribI4uiv")) return emscripten_glVertexAttribI4uiv;
  else if (!strcmp(name, "glVertexAttribI4bv")) return emscripten_glVertexAttribI4bv;
  else if (!strcmp(name, "glVertexAttribI4sv")) return emscripten_glVertexAttribI4sv;
  else if (!strcmp(name, "glVertexAttribI4ubv")) return emscripten_glVertexAttribI4ubv;
  else if (!strcmp(name, "glVertexAttribI4usv")) return emscripten_glVertexAttribI4usv;
  else if (!strcmp(name, "glGetUniformuiv")) return emscripten_glGetUniformuiv;
  else if (!strcmp(name, "glBindFragDataLocation")) return emscripten_glBindFragDataLocation;
  ...
  else if (!strcmp(name, "glTexParameterIiv")) return emscripten_glTexParameterIiv;
  else if (!strcmp(name, "glTexParameterIuiv")) return emscripten_glTexParameterIuiv;
  else if (!strcmp(name, "glGetTexParameterIiv")) return emscripten_glGetTexParameterIiv;
  else if (!strcmp(name, "glGetTexParameterIuiv")) return emscripten_glGetTexParameterIuiv;
  ...
  else if (!strcmp(name, "glTexBuffer")) return emscripten_glTexBuffer;
  else if (!strcmp(name, "glPrimitiveRestartIndex")) return emscripten_glPrimitiveRestartIndex;
  else if (!strcmp(name, "glActiveTextureARB")) return emscripten_glActiveTextureARB;
  else if (!strcmp(name, "glClientActiveTextureARB")) return emscripten_glClientActiveTextureARB;
  else if (!strcmp(name, "glMultiTexCoord1dARB")) return emscripten_glMultiTexCoord1dARB;
  else if (!strcmp(name, "glMultiTexCoord1dvARB")) return emscripten_glMultiTexCoord1dvARB;
  ...
  else if (!strcmp(name, "glLoadTransposeMatrixfARB")) return emscripten_glLoadTransposeMatrixfARB;
  else if (!strcmp(name, "glLoadTransposeMatrixdARB")) return emscripten_glLoadTransposeMatrixdARB;
  else if (!strcmp(name, "glMultTransposeMatrixfARB")) return emscripten_glMultTransposeMatrixfARB;
  else if (!strcmp(name, "glMultTransposeMatrixdARB")) return emscripten_glMultTransposeMatrixdARB;
  else if (!strcmp(name, "glCompressedTexImage3DARB")) return emscripten_glCompressedTexImage3DARB;
  else if (!strcmp(name, "glCompressedTexImage2DARB")) return emscripten_glCompressedTexImage2DARB;
  else if (!strcmp(name, "glCompressedTexImage1DARB")) return emscripten_glCompressedTexImage1DARB;
  else if (!strcmp(name, "glCompressedTexSubImage3DARB")) return emscripten_glCompressedTexSubImage3DARB;
  else if (!strcmp(name, "glCompressedTexSubImage2DARB")) return emscripten_glCompressedTexSubImage2DARB;
  else if (!strcmp(name, "glCompressedTexSubImage1DARB")) return emscripten_glCompressedTexSubImage1DARB;
  else if (!strcmp(name, "glGetCompressedTexImageARB")) return emscripten_glGetCompressedTexImageARB;
  else if (!strcmp(name, "glVertexAttrib1dARB")) return emscripten_glVertexAttrib1dARB;
  else if (!strcmp(name, "glVertexAttrib1dvARB")) return emscripten_glVertexAttrib1dvARB;
  else if (!strcmp(name, "glVertexAttrib1fARB")) return emscripten_glVertexAttrib1fARB;
  else if (!strcmp(name, "glVertexAttrib1fvARB")) return emscripten_glVertexAttrib1fvARB;
  else if (!strcmp(name, "glVertexAttrib1sARB")) return emscripten_glVertexAttrib1sARB;
  else if (!strcmp(name, "glVertexAttrib1svARB")) return emscripten_glVertexAttrib1svARB;
  else if (!strcmp(name, "glVertexAttrib2dARB")) return emscripten_glVertexAttrib2dARB;
  else if (!strcmp(name, "glVertexAttrib2dvARB")) return emscripten_glVertexAttrib2dvARB;
  else if (!strcmp(name, "glVertexAttrib2fARB")) return emscripten_glVertexAttrib2fARB;
  else if (!strcmp(name, "glVertexAttrib2fvARB")) return emscripten_glVertexAttrib2fvARB;
  else if (!strcmp(name, "glVertexAttrib2sARB")) return emscripten_glVertexAttrib2sARB;
  else if (!strcmp(name, "glVertexAttrib2svARB")) return emscripten_glVertexAttrib2svARB;
  else if (!strcmp(name, "glVertexAttrib3dARB")) return emscripten_glVertexAttrib3dARB;
  else if (!strcmp(name, "glVertexAttrib3dvARB")) return emscripten_glVertexAttrib3dvARB;
  else if (!strcmp(name, "glVertexAttrib3fARB")) return emscripten_glVertexAttrib3fARB;
  else if (!strcmp(name, "glVertexAttrib3fvARB")) return emscripten_glVertexAttrib3fvARB;
  else if (!strcmp(name, "glVertexAttrib3sARB")) return emscripten_glVertexAttrib3sARB;
  else if (!strcmp(name, "glVertexAttrib3svARB")) return emscripten_glVertexAttrib3svARB;
  else if (!strcmp(name, "glVertexAttrib4NbvARB")) return emscripten_glVertexAttrib4NbvARB;
  else if (!strcmp(name, "glVertexAttrib4NivARB")) return emscripten_glVertexAttrib4NivARB;
  else if (!strcmp(name, "glVertexAttrib4NsvARB")) return emscripten_glVertexAttrib4NsvARB;
  else if (!strcmp(name, "glVertexAttrib4NubARB")) return emscripten_glVertexAttrib4NubARB;
  else if (!strcmp(name, "glVertexAttrib4NubvARB")) return emscripten_glVertexAttrib4NubvARB;
  else if (!strcmp(name, "glVertexAttrib4NuivARB")) return emscripten_glVertexAttrib4NuivARB;
  else if (!strcmp(name, "glVertexAttrib4NusvARB")) return emscripten_glVertexAttrib4NusvARB;
  else if (!strcmp(name, "glVertexAttrib4bvARB")) return emscripten_glVertexAttrib4bvARB;
  else if (!strcmp(name, "glVertexAttrib4dARB")) return emscripten_glVertexAttrib4dARB;
  else if (!strcmp(name, "glVertexAttrib4dvARB")) return emscripten_glVertexAttrib4dvARB;
  else if (!strcmp(name, "glVertexAttrib4fARB")) return emscripten_glVertexAttrib4fARB;
  else if (!strcmp(name, "glVertexAttrib4fvARB")) return emscripten_glVertexAttrib4fvARB;
  else if (!strcmp(name, "glVertexAttrib4ivARB")) return emscripten_glVertexAttrib4ivARB;
  else if (!strcmp(name, "glVertexAttrib4sARB")) return emscripten_glVertexAttrib4sARB;
  else if (!strcmp(name, "glVertexAttrib4svARB")) return emscripten_glVertexAttrib4svARB;
  else if (!strcmp(name, "glVertexAttrib4ubvARB")) return emscripten_glVertexAttrib4ubvARB;
  else if (!strcmp(name, "glVertexAttrib4uivARB")) return emscripten_glVertexAttrib4uivARB;
  else if (!strcmp(name, "glVertexAttrib4usvARB")) return emscripten_glVertexAttrib4usvARB;
  else if (!strcmp(name, "glVertexAttribPointerARB")) return emscripten_glVertexAttribPointerARB;
  else if (!strcmp(name, "glEnableVertexAttribArrayARB")) return emscripten_glEnableVertexAttribArrayARB;
  else if (!strcmp(name, "glDisableVertexAttribArrayARB")) return emscripten_glDisableVertexAttribArrayARB;
  else if (!strcmp(name, "glProgramStringARB")) return emscripten_glProgramStringARB;
  else if (!strcmp(name, "glBindProgramARB")) return emscripten_glBindProgramARB;
  else if (!strcmp(name, "glDeleteProgramsARB")) return emscripten_glDeleteProgramsARB;
  else if (!strcmp(name, "glGenProgramsARB")) return emscripten_glGenProgramsARB;
  else if (!strcmp(name, "glProgramEnvParameter4dARB")) return emscripten_glProgramEnvParameter4dARB;
  else if (!strcmp(name, "glProgramEnvParameter4dvARB")) return emscripten_glProgramEnvParameter4dvARB;
  else if (!strcmp(name, "glProgramEnvParameter4fARB")) return emscripten_glProgramEnvParameter4fARB;
  else if (!strcmp(name, "glProgramEnvParameter4fvARB")) return emscripten_glProgramEnvParameter4fvARB;
  else if (!strcmp(name, "glProgramLocalParameter4dARB")) return emscripten_glProgramLocalParameter4dARB;
  else if (!strcmp(name, "glProgramLocalParameter4dvARB")) return emscripten_glProgramLocalParameter4dvARB;
  else if (!strcmp(name, "glProgramLocalParameter4fARB")) return emscripten_glProgramLocalParameter4fARB;
  else if (!strcmp(name, "glProgramLocalParameter4fvARB")) return emscripten_glProgramLocalParameter4fvARB;
  else if (!strcmp(name, "glGetProgramEnvParameterdvARB")) return emscripten_glGetProgramEnvParameterdvARB;
  else if (!strcmp(name, "glGetProgramEnvParameterfvARB")) return emscripten_glGetProgramEnvParameterfvARB;
  else if (!strcmp(name, "glGetProgramLocalParameterdvARB")) return emscripten_glGetProgramLocalParameterdvARB;
  else if (!strcmp(name, "glGetProgramLocalParameterfvARB")) return emscripten_glGetProgramLocalParameterfvARB;
  else if (!strcmp(name, "glGetProgramivARB")) return emscripten_glGetProgramivARB;
  else if (!strcmp(name, "glGetProgramStringARB")) return emscripten_glGetProgramStringARB;
  else if (!strcmp(name, "glGetVertexAttribdvARB")) return emscripten_glGetVertexAttribdvARB;
  else if (!strcmp(name, "glGetVertexAttribfvARB")) return emscripten_glGetVertexAttribfvARB;
  else if (!strcmp(name, "glGetVertexAttribivARB")) return emscripten_glGetVertexAttribivARB;
  else if (!strcmp(name, "glGetVertexAttribPointervARB")) return emscripten_glGetVertexAttribPointervARB;
  else if (!strcmp(name, "glIsProgramARB")) return emscripten_glIsProgramARB;
  else if (!strcmp(name, "glBindBufferARB")) return emscripten_glBindBufferARB;
  else if (!strcmp(name, "glDeleteBuffersARB")) return emscripten_glDeleteBuffersARB;
  else if (!strcmp(name, "glGenBuffersARB")) return emscripten_glGenBuffersARB;
  else if (!strcmp(name, "glIsBufferARB")) return emscripten_glIsBufferARB;
  else if (!strcmp(name, "glBufferDataARB")) return emscripten_glBufferDataARB;
  else if (!strcmp(name, "glBufferSubDataARB")) return emscripten_glBufferSubDataARB;
  else if (!strcmp(name, "glGetBufferSubDataARB")) return emscripten_glGetBufferSubDataARB;
  else if (!strcmp(name, "glMapBufferARB")) return emscripten_glMapBufferARB;
  else if (!strcmp(name, "glUnmapBufferARB")) return emscripten_glUnmapBufferARB;
  else if (!strcmp(name, "glGetBufferParameterivARB")) return emscripten_glGetBufferParameterivARB;
  else if (!strcmp(name, "glGetBufferPointervARB")) return emscripten_glGetBufferPointervARB;
  else if (!strcmp(name, "glGenQueriesARB")) return emscripten_glGenQueriesARB;
  else if (!strcmp(name, "glDeleteQueriesARB")) return emscripten_glDeleteQueriesARB;
  else if (!strcmp(name, "glIsQueryARB")) return emscripten_glIsQueryARB;
  else if (!strcmp(name, "glBeginQueryARB")) return emscripten_glBeginQueryARB;
  else if (!strcmp(name, "glEndQueryARB")) return emscripten_glEndQueryARB;
  else if (!strcmp(name, "glGetQueryivARB")) return emscripten_glGetQueryivARB;
  else if (!strcmp(name, "glGetQueryObjectivARB")) return emscripten_glGetQueryObjectivARB;
  else if (!strcmp(name, "glGetQueryObjectuivARB")) return emscripten_glGetQueryObjectuivARB;
  else if (!strcmp(name, "glDeleteObjectARB")) return emscripten_glDeleteObjectARB;
  else if (!strcmp(name, "glGetHandleARB")) return emscripten_glGetHandleARB;
  else if (!strcmp(name, "glDetachObjectARB")) return emscripten_glDetachObjectARB;
  else if (!strcmp(name, "glCreateShaderObjectARB")) return emscripten_glCreateShaderObjectARB;
  else if (!strcmp(name, "glShaderSourceARB")) return emscripten_glShaderSourceARB;
  else if (!strcmp(name, "glCompileShaderARB")) return emscripten_glCompileShaderARB;
  else if (!strcmp(name, "glCreateProgramObjectARB")) return emscripten_glCreateProgramObjectARB;
  else if (!strcmp(name, "glAttachObjectARB")) return emscripten_glAttachObjectARB;
  else if (!strcmp(name, "glLinkProgramARB")) return emscripten_glLinkProgramARB;
  else if (!strcmp(name, "glUseProgramObjectARB")) return emscripten_glUseProgramObjectARB;
  else if (!strcmp(name, "glValidateProgramARB")) return emscripten_glValidateProgramARB;
  else if (!strcmp(name, "glUniform1fARB")) return emscripten_glUniform1fARB;
  else if (!strcmp(name, "glUniform2fARB")) return emscripten_glUniform2fARB;
  else if (!strcmp(name, "glUniform3fARB")) return emscripten_glUniform3fARB;
  else if (!strcmp(name, "glUniform4fARB")) return emscripten_glUniform4fARB;
  else if (!strcmp(name, "glUniform1iARB")) return emscripten_glUniform1iARB;
  else if (!strcmp(name, "glUniform2iARB")) return emscripten_glUniform2iARB;
  else if (!strcmp(name, "glUniform3iARB")) return emscripten_glUniform3iARB;
  else if (!strcmp(name, "glUniform4iARB")) return emscripten_glUniform4iARB;
  else if (!strcmp(name, "glUniform1fvARB")) return emscripten_glUniform1fvARB;
  else if (!strcmp(name, "glUniform2fvARB")) return emscripten_glUniform2fvARB;
  else if (!strcmp(name, "glUniform3fvARB")) return emscripten_glUniform3fvARB;
  else if (!strcmp(name, "glUniform4fvARB")) return emscripten_glUniform4fvARB;
  else if (!strcmp(name, "glUniform1ivARB")) return emscripten_glUniform1ivARB;
  else if (!strcmp(name, "glUniform2ivARB")) return emscripten_glUniform2ivARB;
  else if (!strcmp(name, "glUniform3ivARB")) return emscripten_glUniform3ivARB;
  else if (!strcmp(name, "glUniform4ivARB")) return emscripten_glUniform4ivARB;
  else if (!strcmp(name, "glUniformMatrix2fvARB")) return emscripten_glUniformMatrix2fvARB;
  else if (!strcmp(name, "glUniformMatrix3fvARB")) return emscripten_glUniformMatrix3fvARB;
  else if (!strcmp(name, "glUniformMatrix4fvARB")) return emscripten_glUniformMatrix4fvARB;
  else if (!strcmp(name, "glGetObjectParameterfvARB")) return emscripten_glGetObjectParameterfvARB;
  else if (!strcmp(name, "glGetObjectParameterivARB")) return emscripten_glGetObjectParameterivARB;
  else if (!strcmp(name, "glGetInfoLogARB")) return emscripten_glGetInfoLogARB;
  else if (!strcmp(name, "glGetAttachedObjectsARB")) return emscripten_glGetAttachedObjectsARB;
  else if (!strcmp(name, "glGetUniformLocationARB")) return emscripten_glGetUniformLocationARB;
  else if (!strcmp(name, "glGetActiveUniformARB")) return emscripten_glGetActiveUniformARB;
  else if (!strcmp(name, "glGetUniformfvARB")) return emscripten_glGetUniformfvARB;
  else if (!strcmp(name, "glGetUniformivARB")) return emscripten_glGetUniformivARB;
  else if (!strcmp(name, "glGetShaderSourceARB")) return emscripten_glGetShaderSourceARB;
  else if (!strcmp(name, "glBindAttribLocationARB")) return emscripten_glBindAttribLocationARB;
  else if (!strcmp(name, "glGetActiveAttribARB")) return emscripten_glGetActiveAttribARB;
  else if (!strcmp(name, "glGetAttribLocationARB")) return emscripten_glGetAttribLocationARB;
  else if (!strcmp(name, "glDrawArraysInstancedARB")) return emscripten_glDrawArraysInstancedARB;
  else if (!strcmp(name, "glDrawElementsInstancedARB")) return emscripten_glDrawElementsInstancedARB;
  ...
  else if (!strcmp(name, "glFramebufferTexture1D")) return emscripten_glFramebufferTexture1D;
  else if (!strcmp(name, "glFramebufferTexture2D")) return emscripten_glFramebufferTexture2D;
  else if (!strcmp(name, "glFramebufferTexture3D")) return emscripten_glFramebufferTexture3D;
  ...
  else if (!strcmp(name, "glGetActiveUniformName")) return emscripten_glGetActiveUniformName;
